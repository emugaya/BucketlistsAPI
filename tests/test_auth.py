...
class AuthTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.no_password_supplied = {"username" : "mmmmm",
                                  "password" : ""}
        self.no_username_and_password = {"username":"", "password":""}
    ...
    def test_user_registration_fails_with_no_username_and_password(self):
        res =self.client().post("/api/v1/auth/register/", data=self.no_username_and_password)
        self.assertEqual(res.status_code, 400)
    ...
    def test_user_login_fails_when_username_and_password_are_not_supplied(self):
        res = self.client().post("/api/v1/auth/login/", data=self.no_username_and_password)
        self.assertEqual(res.status_code, 400)
